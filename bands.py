...
BAND_LIST: List[Band] = [
    ...
    # 5G NR FR1 (Sub-6 GHz) - 3GPP TS 38.101-1
    Band("NR_n1", 1920, 1980, 2110, 2170, "NR n1 (2100 FDD)", "5G NR"),
    Band("NR_n2", 1850, 1910, 1930, 1990, "NR n2 (1900 PCS)", "5G NR"),
    Band("NR_n3", 1710, 1785, 1805, 1880, "NR n3 (1800)", "5G NR"),
    Band("NR_n5", 824, 849, 869, 894, "NR n5 (850)", "5G NR"),
    Band("NR_n7", 2500, 2570, 2620, 2690, "NR n7 (2600)", "5G NR"),
    Band("NR_n25", 1850, 1915, 1930, 1995, "NR n25 (1900+)", "5G NR"),
    Band("NR_n28", 703, 748, 758, 803, "NR n28 (700)", "5G NR"),
    Band("NR_n38", 2570, 2620, 2570, 2620, "NR n38 (TDD 2600)", "5G NR"),
    Band("NR_n41", 2496, 2690, 2496, 2690, "NR n41 (TDD 2500)", "5G NR"),
    Band("NR_n66", 1710, 1780, 2110, 2200, "NR n66 (AWS)", "5G NR"),
    Band("NR_n71", 663, 698, 617, 652, "NR n71 (600)", "5G NR"),
    Band("NR_n77", 3300, 4200, 3300, 4200, "NR n77 (TDD C-Band)", "5G NR"),
    Band("NR_n78", 3300, 3800, 3300, 3800, "NR n78 (TDD C-Band)", "5G NR"),
    Band("NR_n79", 4400, 5000, 4400, 5000, "NR n79 (TDD 4.5 GHz)", "5G NR"),
